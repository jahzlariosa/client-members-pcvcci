...
if ( ! class_exists( '\BuddyBossTheme\LifterLMSHelper' ) ) {
	...
	class LifterLMSHelper implements BBLMSHelper {
		...
		public function buddyboss_llms_save_view() {
			...
			if (
				'bb_theme_lifter_membership_grid_list' === $option_name ||
				'bb_theme_lifter_course_grid_list' === $option_name
			) {
				...
				wp_send_json_error( array( 'message' => __( 'Not a valid option', 'buddyboss-theme' ) ) );
				wp_die();
			}
		}
