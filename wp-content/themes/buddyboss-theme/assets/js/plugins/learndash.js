						...
						$.ajax(
							{
								...
								data    : 'action=buddyboss_lms_save_view&option=bb_theme_learndash_grid_list&type=list&nonce=' + bs_data.nonce_list_grid,
						...
						$.ajax(
							{
								...
								url     	: bs_data.ajaxurl,
								nonce       : bs_data.nonce_list_grid,
								data    	: 'action=buddyboss_lms_save_view&option=bb_theme_learndash_grid_list&type=grid&nonce=' + bs_data.nonce_list_grid,
								success 	: function ( response ) {
								}
							}
						);
					...
					$.ajax(
						{
							...
							url     : bs_data.ajaxurl,
							nonce   : bs_data.nonce_list_grid,
							data    : 'action=buddyboss_lms_save_view&option=bb_theme_learndash_grid_list&type=' + view + '&nonce=' + bs_data.nonce_list_grid,
							success : function ( response ) {
							}
						}
					);
