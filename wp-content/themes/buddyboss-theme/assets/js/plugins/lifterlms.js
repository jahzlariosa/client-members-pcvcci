                ...
                if ( $(this).hasClass('layout-list-view') ) {
                    ...
                    if ( $( 'body' ).hasClass( 'post-type-archive-llms_membership' ) ) {
                        $.ajax({
                            ...
                            data    : 'action=buddyboss_llms_save_view&option=bb_theme_lifter_membership_grid_list&type=list&nonce=' + bs_data.nonce_list_grid,
                        ...
                        $.ajax({
                            ...
                            url         : bs_data.ajaxurl,
                            nonce       : bs_data.nonce_list_grid,
                            data        : 'action=buddyboss_llms_save_view&option=bb_theme_lifter_course_grid_list&type=list&nonce=' + bs_data.nonce_list_grid,
                            success     : function (response) {
                            }
                        });
                    }
                    ...
                    if ( $( 'body' ).hasClass( 'post-type-archive-llms_membership' ) ) {
                        $.ajax({
                            ...
                            url     : bs_data.ajaxurl,
                            nonce   : bs_data.nonce_list_grid,
                            data    : 'action=buddyboss_llms_save_view&option=bb_theme_lifter_membership_grid_list&type=grid&nonce=' + bs_data.nonce_list_grid,
                            success : function ( response ) {
                            }
                        });
                    } else {
                        $.ajax({
                            ...
                            url         : bs_data.ajaxurl,
                            nonce       : bs_data.nonce_list_grid,
                            data        : 'action=buddyboss_llms_save_view&option=bb_theme_lifter_course_grid_list&type=grid&nonce=' + bs_data.nonce_list_grid,
                            success     : function (response) {
                            }
                        });
                    }
